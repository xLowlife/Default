...
public: /*  	PUBLIC MEMBER SECTION FOR CLASS	-	-	-	-	-	-	-	  */
	...
	Firm(const char *arg_Name, const char *arg_City)
	{
	...
	virtual void output(ostream &, char = 'V');
...
public: /*  	PUBLIC MEMBER SECTION FOR CLASS	-	-	-	-	-	-	-	  */
	...
	/** 	Initialize Class Constructor Functions	-	-	-	-	-	-	 **/
	Client() : Firm() {}
	Client(const char *arg_Name, const char *arg_City, char arg_Region)
		: Firm(arg_Name, arg_City), Region(arg_Region) {}
	...
	/** 	Initialize Display Output Functions	-	-	-	-	-	-	-	 **/
	virtual void output(ostream &, char = 'V') override;
...
public: /*  	PUBLIC MEMBER SECTION FOR CLASS	-	-	-	-	-	-	-	  */
	...
	/** 	Initialize Class Constructor Functions	-	-	-	-	-	-	 **/
	Vendor() : Firm() {}
	Vendor(const char *arg_Name, const char *arg_City, int arg_Quality)
		: Firm(arg_Name, arg_City), Quality(arg_Quality) {}

	/** 	Initialize Protected Member Get Functions	-	-	-	-	-	 **/
	operator int() { return Quality; }

	/** 	Initialize Protected Member Set Functions	-	-	-	-	-	 **/
	void set_Quality(const int new_Quality) { Quality = new_Quality; }
};
...
int main()
{
	...
	/***	Define Vendors in Vendors Variables	-	-	-	-	-	-	-	***/
	newVendor.set_Name("Coca-Cola");
	newVendor.set_City("Atlanta");
	newVendor.set_Quality(2);

	/***	Define Firms in Firms Variables	-	-	-	-	-	-	-	-	***/
	// f = &newVendor;
	f = &Clients[2];
	// f = new Firm;
