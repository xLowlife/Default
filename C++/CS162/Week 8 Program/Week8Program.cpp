...
- include a method to write the class object to the console screen
(or to any ostream destination, such as the cin object or a sequential file)
- define a student class that "is a" person by inheritance
- add additional data members relevant to this derived class
- declare an array of four students,
- populate the array with data from a disk file or hard-coded
- prompt the user to enter a student id
- display all information about the student or display an error message,
"Student not found," as appropriate
...
/** 	Define Global Class for Persons	-	-	-	-	-	-	-	-	-	 **/

class Person /*  	INITIALIZE CLASS FOR PERSONS	-	-	-	-	-	-	  */
{
private: /*  	PRIVATE MEMBER SECTION FOR CLASS	-	-	-	-	-	-	  */
	/*  	INITIALIZE PRIVATE VARIABLES FOR CLASS	-	-	-	-	-	-	  */
	/** 	Initialize Private Char Arrays for Class	-	-	-	-	-	 **/
	char
		Name[50], // Specify Person's Name
		City[50]; // Specify Person's City
...
void Person::output(ostream &os, char ori)
{
	...
	/*  	CHECK IF ori IS 'V'	-	-	-	-	-	-	-	-	-	-	-	  */
	/** 	If ori is 'V', Display Person Vertically	-	-	-	-	-	 **/
	if (ori == 'V')
	{
		/***	Display Person Vertically	-	-	-	-	-	-	-	-	***/
		os << setw(15) << "Name: " << Name << endl
		   << setw(15) << "City: " << City << endl
		   << endl;
	}

	/** 	Otherwise, Display Person Horizontally	-	-	-	-	-	-	 **/
	else
	{
		/***	Display Person Horizontally	-	-	-	-	-	-	-	***/
		os << setw(15) << Name << ' '
		   << setw(15) << City << endl;
	}
}
...
// Function to Output Persons
// Accepts 1 Ostream Parameter, and 1 Person Parameter
// Returns Void, Passes Data by Member Access
ostream &operator<<(ostream &os, Person p)
{

	/*  	DISPLAY PERSONS	-	-	-	-	-	-	-	-	-	-	-	-	  */
	/** 	Display Persons Vertically	-	-	-	-	-	-	-	-	-	 **/
	p.output(os, 'V');
...
/** 	Define Global Class for Students	-	-	-	-	-	-	-	-	 **/
