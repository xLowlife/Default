...
public:
	...
	struct Person
	{
		...
		string						   // Initialize String(s) for storing String(s)
			...
			personCompany = "Company", // Specify State of Person
			personState = "State",	   // Specify State of Person
			personCity = "City",	   // Specify City of Person
			personType = "Type";	   // Specify Type of Person
		double						   // Initialize Double(s) for storing Double(s)
		...
		int							   // Initialize Int(s) for storing Int(s)
			...
			personID = 0,			   // Specify Index of Person
...
private:
	...
	string
		...
		fileCustomers = "fileCustomers.txt",
