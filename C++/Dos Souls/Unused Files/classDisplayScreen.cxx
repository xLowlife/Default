...
void Game::dsFiles(string dsFileName)
{
	...
	if (fileOpen(dsFile, dsFileName, false) == true)
	{
...
void Game::dsUis(int chapIndex, int pageIndex)
{
	...
	{
		// Display Menu and Take User Choice
		userDouble = dsUiDisplay(chapIndex, pageIndex);
		userInt = userDouble;
...
Game::Person &Game::dsEnemyNew(int floorIndex, int enemyIndex)
{
	...
	Weapon *noWeapon = new Weapon;			// Initialize Weapon(s) for storing Weapon Data
	Armor *noArmor = new Armor;				// Initialize Armor(s) for storing Armor Data
